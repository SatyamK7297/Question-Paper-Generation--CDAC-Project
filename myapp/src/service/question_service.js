...
const getAllQuestionOfQuestionPaperForUser =(questionPaper_id)=>{
    return httpClient.get(`/course/subject/question/questionPaper/${questionPaper_id}`);

}

export default {getAllQuestionBySubject,addQuestion,limitedQuestion,getAllQuestionOfQuestionPaperForUser};